...
DETECTION_SETTINGS_SECTIONS = [
    {
        ...
        "title": "Detection",
        "fields": [
            {"path": "detection.path", "label": "Legacy model path", "help": "Configured V1 detector weight path."},
            {"path": "detection.classes", "label": "Classes", "help": "YOLO class IDs used during V1 bootstrap detection."},
            {"path": "detection.conf", "label": "Confidence threshold", "help": "Minimum confidence for accepted V1 detections."},
            {"path": "detection.iou", "label": "NMS IoU threshold", "help": "Non-max suppression overlap threshold for V1 detections."},
            {"path": "detection.img_size", "label": "Image size", "help": "Inference image size for V1 bootstrap detection."},
            {"path": "detection.max_det", "label": "Max detections", "help": "Maximum detections retained per frame."},
            {"path": "detection.half", "label": "FP16 enabled", "help": "Whether half precision is enabled for V1 detection."},
            {"path": "detection.device", "label": "Detection device", "help": "Torch device string used for V1 detection."},
