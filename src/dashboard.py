...
DETECTION_SETTINGS_SECTIONS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"path": "highlights.camera_motion_window", "label": "Camera motion window", "help": "Frame window used to detect strong pan/zoom highlight moments."},
            {"path": "highlights.camera_motion_deg_per_sec", "label": "Camera motion deg/sec", "help": "Pan-speed threshold used for camera-motion highlight scoring."},
            {"path": "highlights.camera_zoom_delta", "label": "Camera zoom delta", "help": "FOV change threshold used for camera-motion highlights."},
            {"path": "highlights.same_type_cooldown_sec", "label": "Same-type cooldown", "help": "Suppress repeated highlight events of the same type inside this window."},
            {"path": "highlights.motion_only_penalty", "label": "Motion-only penalty", "help": "Down-ranks clips that contain only generic motion signals without goal-pressure context."},
            ...
            {"path": "highlights.score_weights.camera_motion", "label": "Score weight: camera motion", "help": "Relative score weight for strong pan/zoom highlight moments."},
